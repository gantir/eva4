The Notebook for S10s assignment can be found [here](https://github.com/gantir/eva4/blob/develop/s10/s10.ipynb). 

All the modular code is in a separate library [evalib](https://github.com/gantir/evalib/tree/develop/src/evalib).

The final accuracy achieved is 89.84% in 25 Epochs
